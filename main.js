document.addEventListener("DOMContentLoaded", function() {
  // Shopify ayarlarından alınan auth key'i, body'den alıyoruz
const userAuthKey = "{{ settings.auth_key }}".replace(/"/g, '').trim();
  ...
  fetch('https://cdn.jsdelivr.net/gh/altkhaN0/ds@main/allowlist.json')
      ...
      .then(allowlist => {
          ...
          console.log("Giriş yapılan auth key:", userAuthKey); // Debug: kullanıcı anahtarı

          // Auth Key'i allowlist'te bulma
